package com.express56.xq.okhttp;

import android.os.Handler;
import android.os.Looper;

import com.express56.xq.okhttp.builder.GetBuilder;
import com.express56.xq.okhttp.builder.HeadBuilder;
import com.express56.xq.okhttp.builder.OtherRequestBuilder;
import com.express56.xq.okhttp.builder.PostFileBuilder;
import com.express56.xq.okhttp.builder.PostFormBuilder;
import com.express56.xq.okhttp.builder.PostStringBuilder;
import com.express56.xq.okhttp.callback.Callback;
import com.express56.xq.okhttp.cookie.CookieJarImpl;
import com.express56.xq.okhttp.cookie.store.CookieStore;
import com.express56.xq.okhttp.cookie.store.HasCookieStore;
import com.express56.xq.okhttp.cookie.store.MemoryCookieStore;
import com.express56.xq.okhttp.https.HttpsUtils;
import com.express56.xq.okhttp.log.LoggerInterceptor;
import com.express56.xq.okhttp.request.RequestCall;
import com.express56.xq.okhttp.utils.Exceptions;
...
public class OkHttpUtils
{
    ...
    public static void setNeedAddHeadParam(boolean needAddHeadParam) {
        OkHttpUtils.needAddHeadParam = needAddHeadParam;
    }

    /**
     * http头部是否需要添加参数
     */
    private static boolean needAddHeadParam = false;
...
//                        Request newRequest = chain.request().newBuilder().addHeader("appId", HttpHelper.entryptPassword("admin")).build();
...
//            }
        ...
        if (mInstance == null)
        {
            synchronized (OkHttpUtils.class)
            {
                if (mInstance == null)
                {
                    ...
                    mInstance.setWriteTimeout(20, TimeUnit.SECONDS);
                    mInstance.setReadTimeout(30, TimeUnit.SECONDS);
                }
            }
        }
        return mInstance;
    ...
    {
        if (mInstance == null || needAddHeadParam)
//        if (mInstance == null)
        {
            synchronized (OkHttpUtils.class)
            {
