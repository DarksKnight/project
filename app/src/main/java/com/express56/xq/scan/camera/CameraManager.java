...
package com.express56.xq.scan.camera;
...
//					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
			...
			int width = findDesiredDimensionInRange(screenResolution.x,
					MIN_FRAME_WIDTH, MAX_FRAME_WIDTH)*5/5;
			int height = findDesiredDimensionInRange(screenResolution.y,
					MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT)*5/5;

			int leftOffset = (screenResolution.x - width) / 2;
//			int topOffset = (int) ((screenResolution.y - height) / 2 - 80 * DisplayUtil.density);
			int topOffset = (int) ((screenResolution.y - width) / 2 - width * 0.25f);
